...
**Source Code:** [schema/primitives/objects/transactions/transfer/Transfer](../../../../../docs/markdown/schema/primitives/objects/transactions/transfer/Transfer.schema.json)
