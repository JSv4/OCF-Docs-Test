...
**Source Code:** [schema/primitives/objects/transactions/SecurityTransaction](../../../../docs/markdown/schema/primitives/objects/transactions/SecurityTransaction.schema.json)
