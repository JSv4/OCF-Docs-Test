...
**Source Code:** [schema/objects/transactions/retraction/ConvertibleRetraction](../../../../docs/markdown/schema/objects/transactions/retraction/ConvertibleRetraction.schema.json)
