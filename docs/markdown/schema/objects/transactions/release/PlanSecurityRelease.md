...
- [schema/primitives/objects/transactions/release/Release](../../../../../docs/markdown/schema/primitives/objects/transactions/release/Release.md)
...
|                        | **Constant:** `TX_PLAN_SECURITY_RELEASE`</br>_Defined in ../../../enums/ObjectType.md_       | Object type field                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | -          |
...
| settlement_date        | [schema/types/Date](../jman/source/OCF-Docs-Test/docs/markdown/schema/types/Date.md)         | The settlement date for the shares released, typically after the release transaction date                                                                                                                                                                                                                                                                                                                                                                                                                   | `REQUIRED` |
| release_price          | [schema/types/Monetary](../jman/source/OCF-Docs-Test/docs/markdown/schema/types/Monetary.md) | The release price used to determine the value of the security at the time of release                                                                                                                                                                                                                                                                                                                                                                                                                        | `REQUIRED` |
