...
|                    | **Constant:** `VESTING_TERMS`</br>_Defined in [schema/enums/ObjectType.schema.json](../enums/ObjectType.md)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Object type field                                                               | -          |
...
**Source Code:** [schema/objects/VestingTerms](../../docs/markdown/schema/objects/VestingTerms.schema.json)
